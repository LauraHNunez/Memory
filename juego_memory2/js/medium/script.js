...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            "./img/nivel_2/Series/phineasFerb.png",
            "./img/nivel_2/Series/mentes.png",
            "./img/nivel_2/Series/friends.png",
            "./img/nivel_2/Series/GofT.png",
            "./img/nivel_2/Series/hmym.png",
            "./img/nivel_2/Series/originals.png",
            "./img/nivel_2/Series/sense8.png",
            "./img/nivel_2/Series/vikingos.png",
            "./img/nivel_2/Series/doraemon.png",
            "./img/nivel_2/Series/arrow.png",
        ],
        memorama: [],
