...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            "./img/nivel_3/Series/starTreck.png",
            "./img/nivel_3/Series/scorpion.png",
            "./img/nivel_3/Series/mentalista.png",
            "./img/nivel_3/Series/2medio.png",
            "./img/nivel_3/Series/macGyver.png",
            "./img/nivel_3/Series/oliverBenji.png",
            "./img/nivel_3/Series/lyoko.png",
            "./img/nivel_3/Series/spies.png",
            "./img/nivel_3/Series/ZackCody.png",
            "./img/nivel_3/Series/stranger.png",
        ],
        memorama: [],
