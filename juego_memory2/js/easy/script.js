...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            "./img/nivel_1/Series/ncisLA.png",
            "./img/nivel_1/Series/glee.png",
            "./img/nivel_1/Series/anatomiaGrey.png",
            "./img/nivel_1/Series/bigBang.png",
            "./img/nivel_1/Series/inazuma11.png",
            "./img/nivel_1/Series/legacies.png",
            "./img/nivel_1/Series/h2o.png",
            "./img/nivel_1/Series/bwh.png",
            "./img/nivel_1/Series/sherlock.png",
            "./img/nivel_1/Series/elite.png",
        ],
        memorama: [],
