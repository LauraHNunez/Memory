...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            "./img/nivel_3/Peliculas/sonic.png",
            "./img/nivel_3/Peliculas/rocky.png",
            "./img/nivel_3/Peliculas/karateKid.png",
            "./img/nivel_3/Peliculas/clubLucha.png",
            "./img/nivel_3/Peliculas/RLR.png",
            "./img/nivel_3/Peliculas/oceans.png",
            "./img/nivel_3/Peliculas/soulSurfer.png",
            "./img/nivel_3/Peliculas/127horas.png",
            "./img/nivel_3/Peliculas/campeones.png",
            "./img/nivel_3/Peliculas/starWars.png",
        ],
        memorama: [],
