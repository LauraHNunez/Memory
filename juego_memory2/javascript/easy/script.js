...
new Vue({
    ...
    data: () => ({
        ...
        imagenes: [
            "./img/nivel_1/Peliculas/pitchPerfect.png",
            "./img/nivel_1/Peliculas/topgun.png",
            "./img/nivel_1/Peliculas/after.png",
            "./img/nivel_1/Peliculas/culpaMia.png",
            "./img/nivel_1/Peliculas/titanic.png",
            "./img/nivel_1/Peliculas/harryPotter.png",
            "./img/nivel_1/Peliculas/fastFurious.png",
            "./img/nivel_1/Peliculas/starstruck.png",
            "./img/nivel_1/Peliculas/navidad.png",
            "./img/nivel_1/Peliculas/avengers.png",
        ],
        memorama: [],
